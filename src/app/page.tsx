...
export default function Home() {
      ...
      if (fleetSection) {
        ...
        if (scrolled > fleetStart) {
          ...
          const translateY = Math.max(
            -windowHeight * 0.3 * progress,
            -windowHeight * 0.3
          );
          (fleetSection as HTMLElement).style.transform =
  ...
  return (
    <main className="min-h-screen">
          ...
          {bannerImages.map((banner, index) => {
            ...
            return (
              <div
                ...
                {/* Loading placeholder */}
                <div
                  className={`absolute inset-0 bg-gray-300 transition-opacity duration-700 ${
            ...
            <div className="max-w-5xl mx-auto px-4 text-center">
              ...
              <PageHeaderAnimation delay={900}>
                <p className="text-lg md:text-xl text-white/70 mb-12 max-w-2xl mx-auto font-light leading-relaxed">
                  Safe, professional family transport with imported Britax child
                  seats from Sweden
                </p>
              </PageHeaderAnimation>
              ...
              <PageHeaderAnimation delay={1200}>
                <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                  ...
                  <button
                    ...
                    onClick={() =>
                      (window.location.href = "/airport-transfer")
                    }>
      ...
      <SectionSeparator />
      {/* Destination Gallery */}
      <DestinationGallerySection openImageModal={openImageModal} />
      <SectionSeparator />
