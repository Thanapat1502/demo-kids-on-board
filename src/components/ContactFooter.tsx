      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          <div className="text-center group">
            ...
            <h3 className="text-sm font-medium text-gray-900 uppercase tracking-widest mb-2">
              Email
            </h3>
            <p className="text-gray-600 font-light">thanapat15020@gmail.com</p>
          </div>
          ...
          <div className="text-center group">
            ...
            <p className="text-gray-600 font-light">+66 85 099 4775</p>
          </div>
          ...
          <div className="text-center group">
            ...
            <p className="text-gray-600 font-light">Demo</p>
          </div>
        </div>
